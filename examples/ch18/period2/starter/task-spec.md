...
空白 owner 寫「待確認」；空白 due 通常寫「待確認」，但 G04 依 N05 正式批准填 2026-10-11。
不得把未批准的建議日期變成正式期限，不估算逾期。
sources 必須保留批准基線的完整映射；G04 是 tasks.csv:G04;notes.md:N03;notes.md:N05，新增 G05 是 tasks.csv:G05;notes.md:N06。
另輸出 output/report.md，使用二級標題「本週待辦」「待確認」「來源」。
G03 負責人仍待確認；G04 明列 N05 已批准 2026-10-11，說明它取代 N03 的建議狀態，不把 G03 指派給任何人。
